...
{
    // ElectricityFactoryLog
    public partial class ElectricityFactoryLogConfiguration : EntityTypeConfiguration<ElectricityFactoryLog>
    {
        public ElectricityFactoryLogConfiguration()
            : this("dbo")
        {
        }
 
        public ElectricityFactoryLogConfiguration(string schema)
        {
            ToTable(schema + ".ElectricityFactoryLog");
            HasKey(x => x.Id);
            ...
            Property(x => x.FactoryId).HasColumnName("FactoryId").IsRequired().HasColumnType("int");
