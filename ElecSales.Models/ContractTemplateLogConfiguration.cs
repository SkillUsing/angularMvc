...
{
    // ContractTemplateLog
    public partial class ContractTemplateLogConfiguration : EntityTypeConfiguration<ContractTemplateLog>
    {
        public ContractTemplateLogConfiguration()
            : this("dbo")
        {
        }
 
        public ContractTemplateLogConfiguration(string schema)
        {
            ToTable(schema + ".ContractTemplateLog");
            HasKey(x => x.Id);

            Property(x => x.Id).HasColumnName("Id").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(x => x.TemplateId).HasColumnName("TemplateId").IsRequired().HasColumnType("int");
