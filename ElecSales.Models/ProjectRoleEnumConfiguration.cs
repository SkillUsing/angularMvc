...
{
    // ProjectRoleEnum
    public partial class ProjectRoleEnumConfiguration : EntityTypeConfiguration<ProjectRoleEnum>
    {
        public ProjectRoleEnumConfiguration()
            : this("dbo")
        {
        }
 
        public ProjectRoleEnumConfiguration(string schema)
        {
            ToTable(schema + ".ProjectRoleEnum");
            HasKey(x => x.Id);
