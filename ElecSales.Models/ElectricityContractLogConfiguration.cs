...
namespace ElecSales.Models
{
    ...
    public partial class ElectricityContractLogConfiguration : EntityTypeConfiguration<ElectricityContractLog>
    {
        public ElectricityContractLogConfiguration()
            : this("dbo")
        {
        }
 
        public ElectricityContractLogConfiguration(string schema)
        {
            ToTable(schema + ".ElectricityContractLog");
            HasKey(x => x.Id);
            ...
            Property(x => x.ContractId).HasColumnName("ContractId").IsRequired().HasColumnType("int");
            InitializePartial();
        }
